...
void ADSR::UpdateSettings()
{
    ...
    case Phase::Sustain:
        ...
        m_Step = m_Decrease ? static_cast<s8>(-8 + m_Reg.SustainStep.get()) : static_cast<s8>(7 - m_Reg.SustainStep.get());
...
void Volume::Set(u16 volume)
{
    ...
    m_Step = m_Decrease ? static_cast<s8>(-8 + m_Sweep.SweepStep.get()) : static_cast<s8>(7 - m_Sweep.SweepStep.get());
